...
public class VaultListController implements FxController {
	...
	/* This function will syncronize the Vault in Cryptomator and the password stored in the SEcube.
	 * If a Vault is deleted on Cryptomator, using the button in the UI, 
	 * the user can manually syncronize and delete the passwords of the corresponding deleted Vaults.*/
	
	@FXML
	public void didClickSyncVaults() {
		// TODO
	}
