...
public class VaultState extends ObservableValueBase<VaultState.Value> implements ObservableObjectValue<VaultState.Value> {
	...
	/*Added new state for the Vaults locked with SEcube. 
	 *The Vaults that interact with SEcube will assume the state SECUBE when locked.
	 * */
	public enum Value {
		/**
