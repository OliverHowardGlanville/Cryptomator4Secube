...
class VaultSettingsJsonAdapter {
	...
	/* Added value vaultsecube to be written in the json file.
	 * When the application is started, the program will understand the Vault type and set the state to SECUBE or LOCKED.  
	*/
	...
	public void write(JsonWriter out, VaultSettings value) throws IOException {
		...
		out.name("vaultsecube").value(value.getVaultsecube());
	...
	public VaultSettings read(JsonReader in) throws IOException {
		...
		while (in.hasNext()) {
			...
			switch (name) {
				...
				case "vaultsecube" -> vaultsecube = in.nextBoolean();
